...
<div>
    <hgroup class="title">
        <h1>TO ENROLL PLEASE FILL IN ALL THE INFORMATION BELOW</h1>
    </hgroup>
    ...
    <fieldset>
        ...
        <ol>
            ...
            <li>
                ...
                <asp:Label ID="Lblcmpny" runat="server" Text="" Visible="false"></asp:Label>
            </li>
            <li>
                <asp:Label ID="Label12" runat="server" AssociatedControlID="txtuserid">*Company ID :</asp:Label>
                <asp:TextBox ID="txtuserid" runat="server" class="textfiled" ToolTip="Company ID"></asp:TextBox>
                <asp:RequiredFieldValidator CssClass="message-error" Display="Dynamic" ID="RequiredFieldValidator22" runat="server" ControlToValidate="txtuserid" ErrorMessage="Please Enter Company ID" ValidationGroup="REG"></asp:RequiredFieldValidator>
            </li>
            <li>                
            ...
            <li>
                ...
                <p>
                   <b>Disclaimer:</b> 
It is unlawful to knowingly provide materially false, incomplete or misleading facts or information to an insurance 
company or another person for the purpose of defrauding or attempting to defraud the company or the person; 
or to conceal, for the purpose of misleading, information concerning any fact material thereto.Filing a false 
application or submitting false information may lead to penalties that includeimprisonment, fines, denial of 
insurance and civil damages.
            ...
            <li>
                ...
                <asp:Label ID="Label14" runat="server" Font-Bold="true">* I have Read and Agree with the Terms and Conditions Above</asp:Label>
                <asp:Label ID="lblAgreeError" runat="server" ForeColor="Red" Visible="false"></asp:Label>
            </li>
        </ol>
    </fieldset>
</div>