    ...
    <fieldset>
        ...
        <ol>
            ...
            <li>
                ...
                <asp:CalendarExtender ID="txtEventFrom_CalendarExtender" BehaviorID="startdate" runat="server" Format="MM/dd/yyyy" Enabled="True" TargetControlID="txtEventFrom" />
            ...
            <li>
                ...
                <asp:CalendarExtender ID="txtEventTo_CalendarExtender" BehaviorID="enddate" runat="server" Format="MM/dd/yyyy" Enabled="True" TargetControlID="txtEventTo" />
