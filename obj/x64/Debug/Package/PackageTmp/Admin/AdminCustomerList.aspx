...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <asp:GridView ID="grdCustomers" CssClass="footable" CellPadding="5" AutoGenerateColumns="false" AllowPaging="true" PageSize="2" runat="server" ToolTip="Customer's Information" OnPageIndexChanging="grdCustomers_PageIndexChanging" BorderColor="#CACACA" BorderStyle="Solid" BorderWidth="1px">
         ...
         <script type="text/javascript">
             $(function () {
                ...
                $('#<%=grdCustomers.ClientID %>').trigger('footable_expand_first_row');
            }).footable();
        });
    </script>
    </div>
