...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <hgroup class="title">
            <h1>Company Affilation :</h1>
        </hgroup>
        <p class="validation-summary-errors">
            <asp:Label ID="lblSuccess" runat="server" Text=""></asp:Label>
        </p>
        <fieldset>
            <legend>Company Affilation List :</legend>
            <ol>
                <li>
                    <asp:Label ID="Label1" runat="server" AssociatedControlID="ddlCompanyAffil">Company Affilation :</asp:Label>
                </li>
                <li>
