    ...
    <fieldset>
        ...
        <ol>
            <li>
                ...
                <asp:RequiredFieldValidator ID="rqfFN3" runat="server" ControlToValidate="txtFirstName" ErrorMessage="Please Enter First Name" ValidationGroup="REG"></asp:RequiredFieldValidator>
            </li>
            <li>
            ...
            <li>
                <asp:Label ID="Label12" runat="server" AssociatedControlID="txtCountry">Company Affiliation :</asp:Label>
