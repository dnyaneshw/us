<%@ Page Title="Welcome to dscoverage.com - Proof Evidence" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProofEvidence.aspx.cs" Inherits="Insurance.ProofEvidence" %>
    ...
    <div id="tblEvedence" runat="server"
            ...
            <div style="padding-top: 1px; padding-bottom: -35; margin-bottom: 0px;">
                <table style="background-color: White; height: 654px; width: 929px; margin-left: 95px; margin-top: 95px; margin-right: 0px;">
                    ...
                    <tr align="center">
                        <td colspan="2">Business Property Coverage for your name brand product represented for $3,000 subject to a $250 Deductible<br />
&nbsp;Data 
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <asp:Image ID="Image1" ImageUrl="~/Images/logo.png" runat="server" Height="42px" />
                            <br />
